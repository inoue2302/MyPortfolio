export const workHistoryEn = [
  {
    ...
    responsibilities: [
      ...
      "To establish a PR splitting culture, held a study session presentation and developed a Claude skill that automatically determines whether a PR needs to be split and proposes splitting strategies during code review"
    ],
    environment: [
  ...
  },
  {
    ...
    environment: [
      "Docker", "VueJS 2.x, 3.x", "Vuetify", "Lambda (nodejs, python)",
      "Laravel 8.x, 9.x", "PHP 7.x, 8.x",
      "ECS for fargate", "RDS", "EC2", "DynamoDB", "Amplify", "AppSync"
    ]
  },
  {
    title: "Operation and Development of SAAS Business System for Recruitment Agencies",
    ...
    environment: [
      ...
      "PHP 7.x", "Yii", "ES6", "jQuery", "Java", "Tomcat", "ECS for fargate", "RDS"
    ]
  },
  {
    title: "Web Application Development for End-of-Life Support Company",
    ...
    environment: [
      "PHP 7.3", "Laravel 5.x", "VueJS", "ALB", "ECR",
      "ECS for fargate", "EC2", "ElasticBeansTalk", "RDS", "DynamoDB", "AppSync",
      "Amplify", "Cognito/UserPool", "CloudFront", "S3", "GitHubActions"
    ]
  },
  {
    title: "Operation and Improvement of Community Site for Nurses",
  ...
  {
    title: "Overseas Idol Platform App Development",
    ...
    environment: [
      "Laravel 5.8", "PHP 7.2", "ReactNative", "Swagger",
      "EC2", "S3", "CloudFront", "ElasticBeanstalk", "RDS for Aurora", "ElastiCache"
    ]
  },
  {
    title: "Server-side Development for Restaurant Chain Coupon App",
    ...
    environment: [
      "Laravel 5.8", "PHP 7.2", "EC2", "S3", "CloudFront",
      "ElasticBeanstalk", "RDS for Aurora"
    ]
  },
  {
    title: "Replacement Development for National Nursing Exam Preparation App",
    ...
    responsibilities: [
      ...
      "Partially handled iOS and Android development",
      "Developed in 2-week agile sprints, using JIRA for boards"
    ],
    environment: [
      "Swift 4.1", "Kotlin 1.2", "RxSwift", "RxJava2", "RealmSwift", "Firebase",
      "BitBucket", "JIRA", "Confluence"
    ]
  },
  {
    title: "Nurse Shift Management App Development",
    ...
    environment: [
      "Swift 3.1", "RxSwift", "RealmSwift", "BitBucket", "JIRA", "Confluence"
    ]
  },
  {
    title: "Nurse Period Prediction Content Development",
    ...
    environment: [
      "Xamarin.Forms", "C#", "PHP 5.6", "PHP 5.1.6",
      "FuelPHP 1.8", "Ethna", "MySQL 5.6", "CentOS"
    ]
  },
  {
    title: "Operation of Community Site for Nurses",
    ...
    environment: [
      "PHP 5.1.6", "MySQL 5.6", "Ethna", "CentOS"
    ]
  },
  {
    title: "Operation of Native Card Battle Game",
    ...
    environment: [
      "PHP 5.6", "jQuery", "MySQL 5.6", "CentOS"
    ]
  },
  {
    title: "Development and Operation of Native Romance Game",
    ...
    environment: [
      "PHP 5.3", "FuelPHP 1.7", "Unity 4.3",
      "MySQL 5.6", "CentOS"
    ]
  },
  {
    title: "Development and Operation of Native Baseball Game",
  ...
  {
    title: "Social Card Battle Development and Operation",
    ...
    environment: [
      "PHP 5.2", "Symfony 1.7", "MySQL 5.5", "CentOS"
    ]
  },
  {
    title: "Native Casual App Development",
  ...
  {
    title: "Feature Phone Web Content Development",
    ...
    environment: [
      "PHP 5.1", "Ethna", "MySQL", "CentOS", "Apache"
    ]
  },
];
